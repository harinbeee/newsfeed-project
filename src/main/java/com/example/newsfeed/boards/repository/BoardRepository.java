...
public interface BoardRepository extends JpaRepository<Board, Long> {
    ...
    @Query("""
        ...
        FROM Board b LEFT JOIN b.user u LEFT JOIN Friend f ON f.toUser = :userId AND f.fromUser = u
        ORDER BY CASE WHEN f.toUser = :userId THEN 0 ELSE 1 END, b.updatedAt DESC
        """)
