...
public interface BoardRepository extends JpaRepository<Board, Long> {
    ...
    @Query("""
        SELECT new com.example.newsfeed.boards.dto.BoardPageResponseDto(u.id, u.username, u.nickname, b.title, b.contents, COUNT(c), COUNT(l.userId), b.boardImage, b.createdAt, b.updatedAt)
